...
(function () {
  ...
  var translations = {
    es: {
      ...
      login_hint: 'Inicia sesión con tu correo y contraseña. Si aún no la creas, revisa el correo de configuración.',
    ...
    en: {
      ...
      login_hint: 'Sign in with your email and password. If you have not set it yet, check your setup email.',
